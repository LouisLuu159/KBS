...
(14, 'GX03', 'BT02', 'CL05', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'CG03', 'MD1', 'THOAI HOA TIEU NAO DO RUOU'),
...
(17, 'GX01', NULL, 'CL04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'MD2', 'BENH NHUOC CO'),
(18, 'GX03', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'MD3', 'VIEM TIEU NAO'),
...
ALTER TABLE `case`
  ...
  ADD CONSTRAINT `fk_CM` FOREIGN KEY (`Mat`) REFERENCES `mucdocamgiac` (`ID`),
